...
gyp ERR! stack Error: Command failed: E:\python3.7\install\python.EXE -c import sys; print "%s.%s.%s" % sys.version_info[:3];
...
gyp ERR! cwd D:\dll\peiliaoxitong\FEBS-Vue\frontend\node_modules\websocket
